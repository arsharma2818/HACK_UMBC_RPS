      ...
      <section className="relative pt-16 pb-20 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">CryptoCanary</span>
          </h1>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-left max-w-2xl mx-auto">
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              CryptoCanary is an educational tool only. No real cryptocurrency transactions occur on this platform. This tool is
